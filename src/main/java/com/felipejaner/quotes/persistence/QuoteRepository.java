...
public interface QuoteRepository extends JpaRepository<Quote, UUID> {
    ...
    @Query("update Quote q set q.status = com.felipejaner.quotes.domain.QuoteStatus.EXPIRED, q.updatedAt = :now, q.version = q.version + 1 where q.status = com.felipejaner.quotes.domain.QuoteStatus.DRAFT and q.createdAt < :cutoff")
