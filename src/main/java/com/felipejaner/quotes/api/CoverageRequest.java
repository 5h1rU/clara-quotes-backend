...
public class CoverageRequest {
  ...
  public CoverageRequest(
      ...
      Set<@NotNull Condition> conditions,
  ...
  @JsonSetter(nulls = Nulls.FAIL)
  public void setHasPreexistingConditions(Boolean value) {
    this.hasPreexistingConditions = value;
  }

  public Set<@NotNull Condition> conditions() {
    return conditions;
  }

  @JsonSetter(nulls = Nulls.FAIL)
  public void setConditions(Set<@NotNull Condition> value) {
  ...
  @JsonSetter(nulls = Nulls.FAIL)
  public void setTakesPrescriptionMedication(Boolean value) {
    this.takesPrescriptionMedication = value;
  }
  ...
  @JsonSetter(nulls = Nulls.FAIL)
  public void setNeedsSpouseCoverage(Boolean value) {
    this.needsSpouseCoverage = value;
  }
}
