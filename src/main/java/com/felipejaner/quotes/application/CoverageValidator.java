...
public class CoverageValidator {
    public HealthDetails validate(int age, CoverageRequest r) {
        ...
        if (age <= 65) {
            if (r.hasPreexistingConditions() != null || r.conditions() != null ||
                r.takesPrescriptionMedication() != null || r.usesTobacco() != null || r.needsSpouseCoverage() != null)
        ...
        if (r.hasPreexistingConditions() == null) errors.put("hasPreexistingConditions", "Choose Yes or No.");
        if (r.takesPrescriptionMedication() == null) errors.put("takesPrescriptionMedication", "Choose Yes or No.");
        ...
        var conditions = r.conditions() == null ? Set.<com.felipejaner.quotes.domain.Condition>of() : r.conditions();
        ...
        if (!errors.isEmpty()) throw new QuoteValidationException(errors);
        return new HealthDetails(r.hasPreexistingConditions(), conditions, r.takesPrescriptionMedication(), r.usesTobacco(), r.needsSpouseCoverage());
    }
}
